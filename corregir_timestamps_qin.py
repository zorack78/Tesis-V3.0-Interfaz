#!/usr/bin/env python3
"""
Script para corregir timestamps en archivo de caudal de entrada.
...
def corregir_timestamps_qin():
    print("=" * 70)
    print("CORRECCIÓN DE TIMESTAMPS - CAUDAL DE ENTRADA (Qin)")
    print("=" * 70)
    
    # Cargar datos
    input_file = Path("data/raw/BD_Qin_m3_UTC.csv")
    output_file = Path("data/raw/BD_Qin_m3_UTC_CORREGIDO.csv")
